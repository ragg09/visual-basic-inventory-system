...
CREATE SCHEMA IF NOT EXISTS `gunayon_inventory_system` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
CREATE SCHEMA IF NOT EXISTS `inventory_system` DEFAULT CHARACTER SET latin1 ;
...
CREATE  TABLE IF NOT EXISTS `inventory_system`.`manager_login` (
  ...
  `username` VARCHAR(45) CHARACTER SET 'latin1' COLLATE 'latin1_bin' NULL DEFAULT NULL ,
  `password` VARCHAR(45) CHARACTER SET 'latin1' COLLATE 'latin1_bin' NULL DEFAULT NULL ,
  PRIMARY KEY (`man_id`) )
ENGINE = InnoDB
AUTO_INCREMENT = 4
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `inventory_system`.`prod_cus`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `inventory_system`.`prod_cus` (
...
CREATE  TABLE IF NOT EXISTS `inventory_system`.`product_items` (
  `prod_id` INT(11) NOT NULL ,
  `item_id` INT(11) NOT NULL ,
  `date_used` DATE NULL DEFAULT NULL ,
  PRIMARY KEY (`prod_id`, `item_id`) ,
