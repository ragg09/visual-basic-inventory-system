...
CREATE SCHEMA IF NOT EXISTS `final_inventory_system` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
...
CREATE  TABLE IF NOT EXISTS `final_inventory_system`.`sk_product` (
  `skp_id` INT NOT NULL AUTO_INCREMENT ,
  `sk_id` INT NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `final_inventory_system`.`prod_cus` (
  `prod_cus_id` INT NOT NULL AUTO_INCREMENT ,
  `prod_id` INT NOT NULL ,
  `cus_id` INT NOT NULL ,
