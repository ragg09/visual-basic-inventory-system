...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`customer`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`customer` (
  `cus_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `cus_amount_paid` INT(11) NOT NULL ,
  `cus_date` DATE NOT NULL ,
  `cus_item_description` VARCHAR(45) NULL DEFAULT NULL ,
  PRIMARY KEY (`cus_id`) )
ENGINE = InnoDB
AUTO_INCREMENT = 7
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`items`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`items` (
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`supplier`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`supplier` (
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`item_supplier`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`item_supplier` (
  ...
  CONSTRAINT `fk_item_supplier_items1`
    FOREIGN KEY (`item_id` )
    REFERENCES `gunayon_julz`.`items` (`item_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_item_supplier_supplier1`
    FOREIGN KEY (`sup_id` )
    REFERENCES `gunayon_julz`.`supplier` (`sup_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`manager_login`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`manager_login` (
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`manager_monitoring`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`manager_monitoring` (
  ...
  CONSTRAINT `fk_manager_monitoring_manager_login`
    FOREIGN KEY (`man_id` )
    REFERENCES `gunayon_julz`.`manager_login` (`man_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 39
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`manager_supplier`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`manager_supplier` (
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`product` (
  `prod_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `prod_name` VARCHAR(45) NOT NULL ,
  `prod_quantity` VARCHAR(45) NOT NULL ,
  `prod_date` DATE NOT NULL ,
  `prod_selling_cost` INT(11) NOT NULL ,
  PRIMARY KEY (`prod_id`) )
ENGINE = InnoDB
AUTO_INCREMENT = 17
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`prod_cus`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`prod_cus` (
  ...
  CONSTRAINT `fk_prod_cus_customer1`
    FOREIGN KEY (`cus_id` )
    REFERENCES `gunayon_julz`.`customer` (`cus_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_prod_cus_product1`
    FOREIGN KEY (`prod_id` )
    REFERENCES `gunayon_julz`.`product` (`prod_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 7
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`product_items`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`product_items` (
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`storekeeper_login`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`storekeeper_login` (
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`sk_product`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`sk_product` (
  ...
  CONSTRAINT `fk_sk_product_storekeeper_login1`
    FOREIGN KEY (`sk_id` )
    REFERENCES `gunayon_julz`.`storekeeper_login` (`sk_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `gunayon_julz`.`sk_items`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `gunayon_julz`.`sk_items` (
